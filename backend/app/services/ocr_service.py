...
def _load_ocr_modules():
    ...
    return apply_all_preprocesses, search_text
...
def process_image_bytes(image_bytes: bytes) -> OCRResult:
    ...
    apply_all_preprocesses, search_text = _load_ocr_modules()
    _, best_method, best_score, best_text = apply_all_preprocesses(image)
